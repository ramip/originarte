...
<div id="layered_block_left" class="block blue">
{*	<p class="title_block">{l s='Catalog' mod='blocklayered'}</p>*}
	<div class="block_content">
		<form action="#" id="layered_form">
			<div>
                            <div class="title_filter">
                                {l s='busca en esta categoria' mod='blocklayered'}<br>
                                <img src="{$ruta}img/filter-flag.png" alt="{l s='busca en esta categoria' mod='blocklayered'}" style="padding-top:5px">
                            </div>
				{if isset($selected_filters) && $n_filters > 0}
				<div id="enabled_filters" class="hiddenbox">

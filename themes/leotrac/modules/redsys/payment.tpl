	...
	<div class="col-xs-12 col-md-6">
		<p class="payment_module">
			<a class="bankwire" href="javascript:$('#redsys_form').submit();" title="{l s='Conectar con el TPV' mod='redsys'}">	
				<img src="{$module_dir|escape:'htmlall'}img/redsys.png" alt="{l s='Conectar con el TPV' mod='redsys'}" height="48" />
...
<p class="payment_module">
	<a class="bankwire" href="javascript:$('#redsys_form').submit();" title="{l s='Conectar con el TPV' mod='redsys'}">	
		<img src="{$module_dir|escape:'htmlall'}img/payment.jpg" alt="{l s='Conectar con el TPV' mod='redsys'}" height="48" />

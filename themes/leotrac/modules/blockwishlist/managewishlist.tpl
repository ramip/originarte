...
{if $products}
	...
	<div class="wishlistLinkTop">
		...
		<p class="wishlisturl">Permalink : <input type="text" value="{$base_dir_ssl}modules/blockwishlist/view.php?token={$token_wish|escape:'htmlall':'UTF-8'}" readonly="readonly" /></p>
		<p class="submit">

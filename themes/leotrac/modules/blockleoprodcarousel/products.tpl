					...
					<div class="product-container">
						...
						<div class="center_block">
							...
							<div class="div_hide_product">	
								...
								<a href="#" id="wishlist_button{$product.id_product}" title="{l s='Add to wishlist' mod='blockleoprodcarousel'}" class="btn-add-wishlist box-wishlist" onclick="LeoWishlistCart('wishlist_block_list', 'add', '{$product.id_product}', $('#idCombination').val(), 1 ); return false;">{l s='Add to wishlist' mod='blockleoprodcarousel'}</a>
						...
						<div class="right_block">
							...
							<p class="price_container"><span class="price">{if !$priceDisplay}{convertPrice price=$product.price}{else}{convertPrice price=$product.price_tax_exc}{/if}</span></p>{else}<div style="height:21px;"></div>{/if}

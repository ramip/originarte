...
<div class="adresses_bloc row-fluid">
		<ul class="span6 address item {if $order->isVirtual()}full_width{/if}">
		...
		<ul class="span6 address alternate_item" {if $order->isVirtual()}style="display:none;"{/if}>

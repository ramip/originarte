...
<h1 class="title_content title_block"> {l s='My addresses'}</h1>
<br/>
...
<div class="addresses">
	<h3 class="title_block">{l s='Your addresses are listed below.'}</h3>
	<div class="block_content">
		<p>{l s='Be sure to update your personal information if it has changed.'}</p>
		{assign var="adrs_style" value=$addresses_style}
		<div class="bloc_adresses row-fluid clearfix">
		{foreach from=$multipleAddresses item=address name=myLoop}
		<ul class="content_block address {if $smarty.foreach.myLoop.last}last_item{elseif $smarty.foreach.myLoop.first}first_item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if}">

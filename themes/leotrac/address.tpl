...
<h1 class="title_content title_block">{l s='Your addresses'}</h1>
...
<form action="{$link->getPageLink('address', true)|escape:'html'}" method="post" class="std form-horizontal" id="add_address">
	<fieldset>
		...
		<div class="text control-group">
			...
			<div class="controls"><input type="text" class="input-xlarge" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{else}{if isset($address->company)}{$address->company|escape:'html'}{/if}{/if}" /></div>
		</div>
		{/if}
		...
		<div class="control-group required text">
			...
			<div class="controls">
			   <input class="input-xlarge" type="text" name="firstname" id="firstname" value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{else}{if isset($address->firstname)}{$address->firstname|escape:'html'}{/if}{/if}" />
            </div>
		</div>
		{/if}
		...
		<div class="control-group required text">
            ...
            <div class="controls">
			    <input class="input-xlarge" type="text" id="lastname" name="lastname" value="{if isset($smarty.post.lastname)}{$smarty.post.lastname}{else}{if isset($address->lastname)}{$address->lastname|escape:'html'}{/if}{/if}" />
            </div>
		</div>
		{/if}
		...
		<div class="control-group required text">
            ...
            <div class="controls">
			   <input class="input-xlarge" type="text" id="address1" name="address1" value="{if isset($smarty.post.address1)}{$smarty.post.address1}{else}{if isset($address->address1)}{$address->address1|escape:'html'}{/if}{/if}" />
            </div>
        </div>
		{/if}
		...
		<div class="control-group required text">
            ...
            <div class="controls">
			   <input class="input-xlarge" type="text" id="address2" name="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{else}{if isset($address->address2)}{$address->address2|escape:'html'}{/if}{/if}" />
            </div>
		</div>
		{/if}
		...
		<div class="control-group required postcode text">
            ...
            <div class="controls">
			    <input class="input-xlarge" type="text" id="postcode" name="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode|escape:'html'}{/if}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
            </div>
		</div>
		{/if}
		{if $field_name eq 'city'}
		<div class="required control-group text">
			<label for="city" class="control-label">{l s='City'} <sup>*</sup></label>
            <div class="controls">
			    <input class="input-xlarge" type="text" name="city" id="city" value="{if isset($smarty.post.city)}{$smarty.post.city}{else}{if isset($address->city)}{$address->city|escape:'html'}{/if}{/if}" maxlength="64" />
            </div>
		</div>
		{*
		...
		*}
		...
		<div class="required control-group select">
			<label for="id_country" class="control-label">{l s='Country'} <sup>*</sup></label>
            <div class="controls">
			    <select class="input-xlarge" id="id_country" name="id_country"><option value="">-</option>{$countries_list}</select>
            </div>
		</div>
		...
		<div class="required control-group id_state select">
		...
		<div class="textarea control-group">
            ...
            <div class="controls">
			    <textarea class="input-xlarge" id="other" name="other" cols="26" rows="3">{if isset($smarty.post.other)}{$smarty.post.other}{else}{if isset($address->other)}{$address->other|escape:'html'}{/if}{/if}</textarea>
            </div>
		</div>
		...
		<div class="control-group text">
			...
			<div class="controls"><input type="text" class="input-xlarge" id="phone" name="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{else}{if isset($address->phone)}{$address->phone|escape:'html'}{/if}{/if}" /></div>
		</div>
		<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}text control-group">
			...
			<div class="controls">
				<input type="text" class="input-xlarge" id="phone_mobile" name="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{else}{if isset($address->phone_mobile)}{$address->phone_mobile|escape:'html'}{/if}{/if}" />
			</div>
		</div>
		<div class="required text control-group" id="adress_alias">
			...
			<div class="controls"><input class="input-xlarge" type="text" id="alias" name="alias" value="{if isset($smarty.post.alias)}{$smarty.post.alias}{else if isset($address->alias)}{$address->alias|escape:'html'}{elseif !$select_address}{l s='My address'}{/if}" /></div>
		</div>
	</fieldset>
	<p class="submit2">

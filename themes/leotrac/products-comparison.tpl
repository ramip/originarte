...
<div class="blue wraper row-fluid">
<h1 class="title_block"><span>{l s='Product Comparison'}</span></h1>
...
<div class="products_block">
	<table id="product_comparison">
			...
			<td width="{$width}%" class="ajax_block_product comparison_infos"><div class="product-container clearfix">
				...
				<div class="comparison_product_infos">
						<div class="prices_container content_price">
		...
		{else}
			<tr>
				<td></td>
				<td colspan="{$products|@count}">{l s='No features to compare'}</td>
			</tr>
		{/if}

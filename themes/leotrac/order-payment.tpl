...
*}
<div> {* bloque movido desde order-carrier.tpl  *}
...
{if !$opc}<h1 class="title_block" >{l s='Please choose your payment method'}</h1>{else}<h2><span>3</span> {l s='Please choose your payment method'}</h2>{/if}

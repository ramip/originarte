...
{if !isset($errors) OR !sizeof($errors)}
	<h3 class="title_category">{l s='List of products by supplier:'}&nbsp;{$supplier->name|escape:'htmlall':'UTF-8'}</h3>
			...
			<div class="span3">
				<div class="inner">
					<div class="btn-group" id="productsview">
						<a class="leo_btn first" href="#"  rel="view-list"><i class="icon-th-list active"></i></a>
						<a class="leo_btn last" href="#" rel="view-grid"><i class="icon-th"></i></a>
					</div>
				</div>
				</div>

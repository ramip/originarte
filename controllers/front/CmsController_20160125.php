...
class CmsControllerCore extends FrontController
{
	...
	public function init()
	{
		...
		if (isset($_POST['customcontact'])){
			if ( $_POST['bots'] != '' ) {
                header( 'Location: http://flyersbcn.es/es/content/10-error-en-el-envio') ;
            } else {
				if ( $_POST['newsletter'] != '' ) {
				...
				$formcontent="<p>Correo electrónico: $email </p>
				...
				header( 'Location: http://flyersbcn.es/es/content/8-presupuesto-personalizado-enviado') ;
			}
		}
	}

            ...
            <table style="width:99%" border="1">
                <tr>
                    <td colspan="3" style="background-color:#dddddd">
                        {$title|escape:'htmlall':'UTF-8'} {l s='de' pdf='true'}&nbsp;{dateFormat date=$order->date_add full=0}
                    </td>
                </tr>
                <tr>
                    <td>
		...
		<td style="width: 100%;">
			<table style="width: 100%; font-size: 8pt;">
				<tr style="line-height:4px;">
					<td style="text-align: left; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: {if !$tax_excluded_display}45%{else}55%{/if}">{l s='Product / Reference' pdf='true'}</td>
...
*}
				...
				<tr style="line-height:6px;background-color:{$bgcolor};">
					<td style="text-align: left; width: {if !$tax_excluded_display}45%{else}55%{/if}">{$order_detail.product_name}</td>
					<!-- unit price tax excluded is mandatory -->
					{if !$tax_excluded_display}
...
{*					<td style="width: 17%; text-align: right;">-{displayPrice currency=$order->id_currency price=($order_invoice->total_discount_tax_incl)}</td> *}
				...
				<tr style="line-height:5px;background-color: #f7f7f7">
					<td style="text-align: right; font-weight: bold">{l s='Total sin IVA' pdf='true'} </td>
				...
				<tr style="line-height:5px;background-color: #dddddd">

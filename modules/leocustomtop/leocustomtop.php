 ...
 * loftwitter Class
 */	
class leocustomtop extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomtop';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Display Custom TOP ');
		$this->description = $this->l('Display Custom HTML ADS PRO TOP, Support All hooks');
    ...
    */
	...
	function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="<div><img src=\"" . __PS_BASE_URI__ . "modules/leocustomtop/images/1.jpg\" alt=\"\" /></div>";
		}

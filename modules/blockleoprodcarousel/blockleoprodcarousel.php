...
class BlockLeoProdCarousel extends Module {
    ...
    public function getContent() {
        ...
        if (Tools::isSubmit('submitSpecials')) {
            ...
            $this->_clearCache('blockleoprodcarousel.tpl');
    ...
    public function hookRightColumn($params) {
        if (!$this->isCached('blockleoprodcarousel.tpl', $this->getCacheId())) {
            $this->_includeFile();
        ...
        return $this->display(__FILE__, 'blockleoprodcarousel.tpl', $this->getCacheId());
    }

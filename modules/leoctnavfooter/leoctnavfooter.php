 ...
 * loftwitter Class
 */
class leoctnavfooter extends Module {
    ...
    function __construct() {
        $this->name = 'leoctnavfooter';
        parent::__construct();
        $this->author = 'leotheme';
        $this->version = '1.1';
        $this->displayName = $this->l('Display Custom HTML Navfooter');
        $this->description = $this->l('Display Custom HTML Navfooter, Support All hooks');
    ...
    function install() {
        if (!parent::install())
            return false;
        if (!$this->registerHook('displayFootNav'))
            return false;
   ...
   function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="<ul>

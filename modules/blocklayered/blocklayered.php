...
class BlockLayered extends Module
{
	...
	public function install()
	{
		...
		&& $this->registerHook('postProcessAttribute') && $this->registerHook('afterDeleteAttribute') && $this->registerHook('afterSaveAttribute') && $this->registerHook('displayLayeredTop'))
		{
	...
	public function hookRightColumn($params)
	{
        ...
        // add by ramiro
	public function hookdisplayLayeredTop($params)
	{ 
		return $this->generateFiltersBlock($this->getSelectedFilters());
	}
...
// funcion de una version anterior pero permite filtrar bien los precios        
	...
	// funcion original del modulo porque no permite filtrar con los precios por defecto correctos.
	public function original_getProductByFilters($selected_filters = array())
	{
		global $cookie;
...
// Generar atributos para cada producto  -- add by ramiro
$prodAttributes = '';  
$prodCombinations = '';
if($products) {

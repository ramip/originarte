 ...
 * loftwitter Class
 */	
class leoctslide extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leoctslide';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Display Custom HTML slide');
    ...
    */
	function install(){
		if (!parent::install())
			return false;
		if(!$this->registerHook('displaySlideshow'))
			return false;
	...
	function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="<a href=\"#\" title=\"adv\"><img src=\"" . __PS_BASE_URI__ . "modules/leoctslide/images/avd_1.png\" alt=\"\" /></a>";
		}

 ...
 * loftwitter Class
 */	
class leocustomcenter extends Module
{
	/**
    ...
    */
	function __construct(){
		$this->name = 'leocustomcenter';
		parent::__construct();			
		$this->author = 'leotheme';				
		$this->version = '1.1';
		$this->displayName = $this->l('Display Custom Center');
    ...
    */
	...
	function contentDefault() {
		foreach( $this->_languages as $language ){
			$contentDefault[$language['iso_code']] ="<a href=\"#\" title=\"adv\"><img src=\"" . __PS_BASE_URI__ . "modules/leocustomcenter/images/adv1.png\" alt=\"\" /></a>";
		}
